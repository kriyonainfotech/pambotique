  ...
  return (
    <div className="space-y-12">
      ...
      <section className="relative">
        <img src={Home1} alt="Hero" className="w-full h-[500px] object-cover" />
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-4  p-4 ">
              <p className="text-sm font-medium text-gray-700">
                Celebrate the history of rich Indian traditions and culture with
                a high-quality and outstanding range of women’s ethnic wear.
                Each bespoke design is a reflection of craftsmanship, making you
                look stunning on every occasion.
              </p>
            </div>
          </div>
          <div className="relative">
            ...
            />
            <div className="absolute bottom-4 left-4 p-4 "></div>
          </div>
        </div>
